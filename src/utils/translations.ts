...
export const translations = {
		...
		shareModalTitle: "Jaa kaverille",
		shareModalDescription:
			"Näytä QR-koodi kaverille tai kopioi linkki, niin he pääsevät sivustolle nopeasti.",
		shareTargetLabel: "Mitä jaetaan",
		shareHomepage: "Perusnäkymä",
		shareCurrentView: "Nykyiset valinnat",
		qrCodeAlt: "QR-koodi, joka johtaa Lähijunat Live -sivustolle",
		copyLink: "Kopioi linkki",
		linkCopied: "Linkki kopioitu!",
		copyLinkFailed: "Linkin kopiointi epäonnistui",
		nativeShare: "Jaa…",
		shareFailed: "Jakaminen epäonnistui",
		closeShareModal: "Sulje",
		keywords:
		...
		closeStationSelector: "Sulje asemavalitsin",
		...
		noTrainsInWindow: "Ei junia tällä välillä seuraavan vuorokauden aikana.",
	...
	en: {
		...
		shareModalTitle: "Share with a friend",
		shareModalDescription:
			"Show the QR code to a friend or copy the link so they can open the site quickly.",
		shareTargetLabel: "What to share",
		shareHomepage: "Homepage",
		shareCurrentView: "This view",
		qrCodeAlt: "QR code linking to Lähijunat Live",
		copyLink: "Copy link",
		...
		closeStationSelector: "Close station selector",
		...
		noTrainsInWindow: "No trains on this route in the next 24 hours.",
	...
	sv: {
		...
		shareModalTitle: "Dela med en vän",
		shareModalDescription:
			"Visa QR-koden för en vän eller kopiera länken så att de snabbt kommer till webbplatsen.",
		shareTargetLabel: "Vad ska delas",
		shareHomepage: "Startsida",
		shareCurrentView: "Den här vyn",
		qrCodeAlt: "QR-kod som leder till Lähijunat Live",
		copyLink: "Kopiera länk",
		linkCopied: "Länk kopierad!",
		copyLinkFailed: "Det gick inte att kopiera länken",
		nativeShare: "Dela…",
		shareFailed: "Delningen misslyckades",
		closeShareModal: "Stäng",
		keywords:
		...
		closeStationSelector: "Stäng stationsväljaren",
		...
		noTrainsInWindow: "Inga tåg på den här sträckan under det närmaste dygnet.",
