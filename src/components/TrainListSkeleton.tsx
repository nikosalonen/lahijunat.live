	...
	return (
		<div class="max-w-4xl mx-auto space-y-6 px-0 sm:px-4">
			...
			<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 px-2">
				<div class="bg-gray-200 dark:bg-gray-700 rounded h-8 w-64 animate-pulse order-2 sm:order-1" />
				<div class="bg-gray-200 dark:bg-gray-700 rounded-full h-6 w-6 animate-pulse self-end sm:self-auto order-1 sm:order-2" />
			</div>
